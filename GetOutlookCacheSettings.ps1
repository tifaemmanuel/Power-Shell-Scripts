            ...
            foreach ($subName in ($regKey.getsubkeynames())) {
                ...
                ForEach($Profile in ($OutlookProfiles.GetSubKeyNames())) {
                    ...
                    If(($ProfileKey.GetValueNames() -contains "00036601") -eq $True) {
                        ...
                        #Profile name
                        $Result4 = $ProfileKey.GetValue("001e6750") 
                        ...
                        $comGroupObjOP = New-Object System.Object
                            $comGroupObjOP | Add-Member -MemberType NoteProperty -Name "Username" -Value $User.Name
                            $comGroupObjOP | Add-Member -MemberType NoteProperty -Name "Profile Name" -Value $Result4
                            $comGroupObjOP | Add-Member -MemberType NoteProperty -Name "Email Account" -Value $Result5
                            $comGroupObjOP | Add-Member -MemberType NoteProperty -Name "Cache Mode" -Value $CacheMode
                            $comGroupObjOP | Add-Member -MemberType NoteProperty -Name "Cache Size" -Value $CacheSize
